...
if (a.domCmp(["vidoza.net", "videowood.tv", "l2s.io", "adshort.co", "linksh.top", "adshorte.com",
    ...
    "urle.co", "oload.info", "shink.me", "doramasflv.net", "backin.net", "adshort.im" "coin.mg"])) {
    a.filter("open");
}
...
if (a.domCmp(["apkmirror.com", "freepdf-books.com", "bc.vc", "themeslide.com", "linkdrop.net",
    ...
    "link-money.com", "meulink.tk", "mlink.club", "shink.xyz", "tui.click", "adshort.im", "123link.press", "coin.mg"])) {
